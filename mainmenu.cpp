...
#pragma region bool
    ...
    show_add_word_window = show_rewards_window = show_add_a_list_of_words_active = show_general_vocabulary_active = show_irregular_verbs = false;
    ...
    once_try = show_mainmenu = once_calculate = true;
...
#pragma region int and float
    array_size = progression_float = levels = chapter_int = inputed_word = correct_words = add_list_button = added_words = progression_int = finish_inputed_verb = finish_inputed_word = 0;
...
void mainmenu::run_window()
{
    ...
    while (this->window->isOpen())
    {
        ...
        if (finish_inputed_word == 1 && show_add_a_list_of_words_active)
        {
            ...
            {
            case 1:
                add_a_list_of_words_en_fr(add_word_en_str);
                break;

            case 2:
                add_a_list_of_words_en_ro(add_word_en_str);
                break;

            case 3:
                add_a_list_of_words_fr_ro(add_word_en_str);
                break;

            case 4:
                add_a_list_of_words_en_fr_ro(add_word_en_str);
                break;
            }
            finish_inputed_word = 0;
            add_word_en_str = "";
