...
private:
	...
	sf::Text word_to_translate, translation, correction, other_traductions, synonyms, progression, finish, add_word_en, add_word_fr;
	...
	int finish_inputed_verb, finish_inputed_word, add_list_button;
	...
	bool once, once_try, is_dark, dark_mode, once_dark_light;
	bool add_word_en_fr_bool, add_word_en_ro_bool, add_word_fr_ro_bool, point_found;
